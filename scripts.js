...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('get-assets').addEventListener('click', getOpenseaItems)
    ...
    async function getOpenseaItems() {
        ...
        const items = await fetch(
            `https://api.opensea.io/api/v1/assets?owner=${window.userAddress}&order_direction=desc&offset=0&limit=50`, options
        )
        .then((res) => res.json())
        .then((res) => {
            return res.assets
